  ...
  return (
    <>
      <Section
        id="top"
        bordered={false}
        className="isolate lg:flex lg:min-h-screen lg:flex-col"
      >
        <HeroBackground />
        <ConcaveRails />

        <div className="relative z-10 px-6 py-24 text-center sm:px-8 sm:py-32 lg:pt-[15vh] lg:pb-0">
          <p className="mb-4 text-base leading-relaxed text-pretty text-muted-foreground sm:text-lg">
            I'm Monza
          </p>
          <h1 className="text-6xl font-medium leading-[1.05] tracking-tighter text-foreground sm:text-6xl lg:text-[5vw]">
